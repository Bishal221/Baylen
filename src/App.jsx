...
const App = () => {
  ...
  const [mapSrc, setMapSrc] = useState('https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3662.981438938617!2d85.3248989!3d23.352687!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39f4e1bcbbc40e23%3A0xa6aea8192f8f434!2sBAYLEN%20d%C3%A9%20Louis%2C%20Best%20Salon%20of%20Main%20Road%2C%20Ranchi!5e0!3m2!1sen!2sin!4v1708253359769!5m2!1sen!2sin');
  ...
  const categories = [
    ...
    { name: 'Ranchi', subCategories: ['Doranda', 'Main Road', 'Kokar', 'Kanke', 'Lalpur Academy', 'Lalpur Salon'] },
  ...
  const handleSubCategoryChange = (e) => {
    ...
    // Example: 
    const mapLinks = {
      '4D Squre Mall': 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3669.8457879500224!2d72.5954076!3d23.1027404!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x395e83580ce20103%3A0x400194d79eb4cd3!2sBAYLEN%20De%20Louis%2C%20Ahmedabad!5e0!3m2!1sen!2sin!4v1708253295587!5m2!1sen!2sin',
      'Doranda': 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3663.1719710092148!2d85.3235031!3d23.3457834!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39f4e1b07b6f4731%3A0xc3704b8d6f14502a!2sBAYLEN%20d%C3%A9%20Louis%2C%20Best%20Salon%20of%20Doranda%20Kadru%2C%20Ranchi!5e0!3m2!1sen!2sin!4v1708253332294!5m2!1sen!2sin',
      'Main Road': 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3662.981438938617!2d85.3248989!3d23.352687!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39f4e1bcbbc40e23%3A0xa6aea8192f8f434!2sBAYLEN%20d%C3%A9%20Louis%2C%20Best%20Salon%20of%20Main%20Road%2C%20Ranchi!5e0!3m2!1sen!2sin!4v1708253359769!5m2!1sen!2sin',
      'Kokar': 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3662.3066370641595!2d85.3597903!3d23.377121799999998!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39f4e31077688441%3A0x56c20cb78234bdcc!2sBAYLEN%20d%C3%A9%20Louis-Best%20Salon%20of%20Ranchi%2CKokar!5e0!3m2!1sen!2sin!4v1708253400346!5m2!1sen!2sin',
      'Kanke': 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3661.7925499076428!2d85.31442299999999!3d23.395720900000004!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39f4e1517d70dc4b%3A0xc9aebdae72ea5dfe!2sBAYLEN%20d%C3%A9%20Louis%2C%20Best%20Salon%20in%20Kanke%20Ranchi!5e0!3m2!1sen!2sin!4v1708253457472!5m2!1sen!2sin',
      'Lalpur Academy': 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3662.4444612510715!2d85.338267!3d23.3721331!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39f4e1295bab510d%3A0x1a97987f9a99a29c!2sBAYLEN%20d%C3%A9%20Louis%20Salon%2C%20Mall%20Decor%2C%20Lalpur%20Chowk!5e0!3m2!1sen!2sin!4v1708253497089!5m2!1sen!2sin',
      'Lalpur Salon': 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3662.4447319710425!2d85.33827099999999!3d23.3721233!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39f4e1b898eef271%3A0x8dfbe8b16311ea48!2sEuropian%20Beauty%20and%20Healtcare%20Pvt%20Ltd!5e0!3m2!1sen!2sin!4v1708253548156!5m2!1sen!2sin',
      'Lohardaga': 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d24625.371525471906!2d84.68607047099833!3d23.439412462559996!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x662fe7e0d02a9151%3A0x1f670e827826f072!2sBaylen%20D%C3%A9%20Louis%20Lohardaga!5e0!3m2!1sen!2sin!4v1708253638291!5m2!1sen!2sin',
      'Hazaribagh': 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3644.9805419374884!2d85.35765459999999!3d23.9964642!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39f49dab470bf82f%3A0xd6e0d835780b96ce!2sBaylen%20De%20Louis%20Hazaribagh!5e0!3m2!1sen!2sin!4v1708253683956!5m2!1sen!2sin',
    };
      ...
      <section className='relative overflow-hidden bg-black'>
        <nav className='absolute w-full z-40 py-4 px-5'>
          <div className='relative flex flex-wrap items-center justify-between'>
            ...
            <div className='flex gap-x-3 items-center justify-between'>
              ...
              <button onClick={handleMenutoggle} className='bg-pink-600 text-white px-3 py-1'><i className="fa-solid fa-bars"></i></button>
            </div>
          </div>
        </nav>
        <aside className={`fixed bg-black h-screen max-w-72 w-full top-0 ${menuActive ? 'right-0' : '-right-96'} z-50 transition-right duration-300`}>
          <div className=' w-full h-full relative flex flex-col justify-center'>
            <button onClick={handleMenutoggle} className='bg-pink-600 text-white px-4 py-2 absolute top-0 -left-[45px]'><i className="fa-solid fa-bars"></i></button>
        ...
        <header className='lg:w-screen w-full h-[500px] md:h-[700px] lg:h-screen relative flex justify-center items-center z-10 px-4 overflow-hidden'>
          <video muted src='/Res/Main-Banner.mp4' className='w-full h-full object-cover object-center absolute top-0 left-0 -z-10' autoPlay={true} loop='loop' />
        ...
        <section className='py-28 flex justify-center items-center px-4 flex-col'>
          ...
          <div className='mt-10 max-w-[1100px] flex justify-center items-center md:flex-row flex-col'>
            ...
            <div className='w-full md:w-auto min-h-[440px]'>
              ...
              <p className='text-pink-600 lg:text-base text-sm max-w-[800px] mb-5'>Baylen De Louis sets a new standard in the realm of celebrity family salons across India, boasting a remarkable seven-star experience. Our salon offers an extensive array of services tailored to cater to the diverse needs of individuals and families alike. From trendy haircuts to rejuvenating spa treatments, we pride ourselves on delivering top-notch services using premium products and the latest techniques.</p>
              {toggleExplore && <p className='text-pink-600 lg:text-base text-sm max-w-[600px] mb-5'>At Baylen De Louis, we prioritize not just style, but also comfort and relaxation. Our luxurious ambiance creates a welcoming atmosphere where clients can unwind and indulge in self-care. With a team of highly skilled and trained professionals, we ensure that each client receives personalized attention and leaves feeling pampered and satisfied.</p>}
              <button onClick={handleToggleExplore} className='bg-pink-600 py-2 px-6 text-white w-fit flex justify-center items-center gap-x-3' href="#">Explore Now <span className={`text-sm ${toggleExplore ? 'rotate-90' : ''}`}><i className="fa-solid fa-angle-right"></i></span></button>
            </div>
          </div>
        </section>
        ...
        <section className='flex flex-col justify-center items-center py-16 gap-y-10 px-4'>
          ...
          <div className='max-w-[1200px] max-h-[700px] h-full w-full overflow-hidden'>
            <Swiper className="mySwiper max-h-[650px] h-full" slidesPerView={1}
              ...
              <SwiperSlide className='w-full h-full'><img className='w-full h-full object-cover' src="/Res/FILE-7912 2.webp" alt="" /></SwiperSlide>
            ...
            <div className='flex justify-center items-center gap-x-6 py-5'>
              <button className='text-pink-600 text-2xl' onClick={preSlide}><i className="fa-solid fa-arrow-left-long"></i></button>
              <p className='text-pink-600'>{currentSlide} / {totalslide}</p>
              <button className='text-pink-600 text-2xl' onClick={nextSlide}><i className="fa-solid fa-arrow-right-long"></i></button>
            </div>
          </div>
        </section>
            ...
            <div className=' w-full md:w-1/2 order-2 md:order-1'>
              ...
              <div className='flex md:items-start items-center flex-col gap-y-8 sm:text-base text-sm text-center'>
                ...
                <div className='flex  items-center gap-x-5'>
                  ...
                  <a className='bg-white flex justify-center items-center text-xl text-pink-600 hover:text-white hover:bg-pink-600 transition-all duration-300 font-medium uppercase w-9 h-9 rounded-full' href="#"><i className="fa-brands fa-youtube"></i></a>
                  <a className='bg-white flex justify-center items-center text-xl text-pink-600 hover:text-white hover:bg-pink-600 transition-all duration-300 font-medium uppercase w-9 h-9 rounded-full' href="#"><i className="fa-brands fa-instagram"></i></a>
                  <a className='bg-white flex justify-center items-center text-xl text-pink-600 hover:text-white hover:bg-pink-600 transition-all duration-300 font-medium uppercase w-9 h-9 rounded-full' href="#"><i className="fa-brands fa-linkedin-in"></i></a>
                  <a className='bg-white flex justify-center items-center text-xl text-pink-600 hover:text-white hover:bg-pink-600 transition-all duration-300 font-medium uppercase w-9 h-9 rounded-full' href="#"><i className="fa-brands fa-x-twitter"></i></a>
                </div>
                <div className='flex  items-center gap-x-5'>
                  <p className='text-white hover:text-pink-600 transition-all duration-300 font-medium uppercase'>Copyright © {year}. <span className='uppercase'>europian beauty & healthcare pvt.ltd.</span></p>
                </div>
              </div>
            </div>
            <div className='flex justify-center w-full md:w-1/2 order-1 md:order-2 xl:max-w-[700px] xl:w-full gap-x-6 xl:flex-row flex-col gap-y-5'>
              <div className='w-full lg:w-[40%]'>
                ...
                <div className='mt-6 flex flex-col gap-y-5'>
                  <div className=''>
                    <label htmlFor="districts" className="block mb-2 text-sm font-medium text-gray-900 dark:text-pink-600">Select Location</label>
                    <select value={category} onChange={handleCategoryChange} id="districts" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-[#171717] dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                  ...
                  {category && (
                    <div className=''>
                      <label className='block mb-2 text-sm font-medium text-pink-600'>Select Branch</label>
                      <select value={subCategory} onChange={handleSubCategoryChange} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-[#171717] dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        <option disabled value="">Select Outlet</option>
                        {categories.find(cat => cat.name === category).subCategories.map((subCat, index) => (
