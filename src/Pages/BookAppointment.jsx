      ...
      <section className="bg-black">
        ...
        <section className="pt-28 pb-8 px-6 text-white">
          <div className="p-6 rounded-lg container mx-auto shadow-md">
            <h2 className="text-3xl text-pink-600 font-bold mb-3">
              Appointment Form
            </h2>
            <p className="text-white mb-8 text-lg">
              Our skilled professionals are dedicated to enhancing your beauty
              and boosting your confidence. Book your appointment now and
              indulge in a world of relaxation and elegance.
            </p>
            <form className="text-white">
              <div className="grid grid-cols-2 gap-3">
                <div className="w-full sm:col-span-1 col-span-2">
                  ...
                  <input
                    ...
                    name="name"
                    className="w-full p-3 bg-[#2e2e2e] mt-1"
                ...
                <div className="w-full sm:col-span-1 col-span-2">
                  <label htmlFor="mobileNo" className="text-lg font-medium">
                    Mobile No:
                  </label>
                  <input
                    type="number"
                ...
                <div className="w-full sm:col-span-1 col-span-2">
                  ...
                  >
                    ...
                    {formData.serviceCategory &&
                      serviceOptions[formData.serviceCategory].map(
                        (service) => (
                ...
                <div className="w-full sm:col-span-1 col-span-2">
                  ...
                  <input
                    ...
                    className="w-full p-3 bg-[#2e2e2e] mt-1 text-white"
                    onChange={handleInputChange}
                  />
                </div>
                <div className="w-full sm:col-span-1 col-span-2">
                  <label
                    htmlFor="durationOfService"
                    className="text-lg font-medium"
                  >
                    Duration of Service:
                  </label>
                ...
                <div className="col-span-2">
                  ...
                  <textarea
                    ...
                    placeholder="If any additional instructions"
                    name="additionalInstructions"
                    className="w-full h-[150px] resize-none p-3 bg-[#2e2e2e] mt-1"
                    onChange={handleInputChange}
                  ></textarea>
                </div>
              </div>
              <button
                type="submit"
                className="bg-pink-600 text-white font-bold py-3 px-10 rounded mt-6"
              >
                Submit
              </button>
            </form>
