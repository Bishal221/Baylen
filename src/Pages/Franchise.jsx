        ...
        <>
            ...
            <section className="pt-28 pb-8 px-6">
                <ul className="text-lg flex-wrap flex justify-center items-center list-disc gap-x-10 gap-y-3 max-w-[1500px] mx-auto font-normal">
                    <li className="px-2 text-white hover:text-pink-600 pb-6 border-b border-[rgba(255,255,255,0.6)] hover:border-pink-600 hover:border-b-2 transition-all duration-300"><a href="#section1">Franchise Kit</a></li>
                    <li className="px-2 text-white hover:text-pink-600 pb-6 border-b border-[rgba(255,255,255,0.6)] hover:border-pink-600 hover:border-b-2 transition-all duration-300"><a href="#section2">Our Modules</a></li>
                    <li className="px-2 text-white hover:text-pink-600 pb-6 border-b border-[rgba(255,255,255,0.6)] hover:border-pink-600 hover:border-b-2 transition-all duration-300"><a href="#section3">Enquire Now</a></li>
                </ul>
            </section>
                    ...
                    <div className="w-full md:w-1/2 relative z-10 md:pt-10">
                        ...
                        <a href='#' target='_blank' className='sm:pl-10 pt-3 flex gap-x-2'>
                            ...
                            <div className='text-white'>
                                ...
                                <p>for <span className='text-pink-600 font-medium'>Download</span></p>
                            </div>
                        </a>
            ...
            <section id="section2" className="px-6 text-white py-16">
                <div className='container mx-auto'>
                    <div className='relative'>
                        ...
                        <img className="xl:max-w-[225px] top-0 max-w-[100px] opacity-20 animate-pulse absolute w-full hidden lg:block left-[55%] z-50" src="./Res/watermark-icon.png" alt="" />
                    </div>
                    <div className='flex items-center justify-center md:flex-row flex-col gap-y-8 relative pt-6'>
                        <div className='md:max-w-[400px] w-full'>
                            ...
                            <div className='border border-[rgba(255,255,255,0.5)] px-10 py-6 flex flex-col gap-y-5'>
                                <h1 className='text-pink-600 text-2xl font-semibold'>LITE MODULE</h1>
            ...
            <section id="section3" className="px-6 text-white py-16">
                <div className='flex items-center flex-col md:flex-row gap-y-5'>
                    <div className="pr-1 hover:before:border-pink-600 before:transition-all before:duration-300 w-full md:w-1/2 relative before:absolute before:w-full before:h-full before:border-4 before:bg-transparent before:animate-updown before:left-4 before:border-white before:z-20">
                        <img className="" src="./Res/Haircutting.jpg" alt="" />
                    </div>
                    <div className='md:w-1/2 w-full md:ml-10'>
                        <div className='flex flex-col justify-center items-center  w-full'>
                            <div className='w-full md:max-w-[600px]'>
                                <h1 className='text-[2.25rem] uppercase lg:text-[3.5rem] 2xl:text-[3.5rem] text-pink-600 text-center md:text-left font-bold'>Enquire <span className='font-light'>now</span></h1>
                                <form action="#" className='flex items-center flex-col justify-center w-full'>
                                    ...
                                    <button className='uppercase px-11 ml-auto mt-4 font-medium py-3 rounded-full bg-pink-600'>submit</button>
                                </form>
                            </div>
                        </div>
                    </div>
            ...
            <section className="py-16 overflow-hidden">
                <img className='object-cover w-full max-h-[500px] h-auto object-center' src="./Res/haircuutingFooter.jpg" alt="" />
            </section>
